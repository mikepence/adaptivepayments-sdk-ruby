  ...
  module AdaptivePayments
    module DataTypes
      ...
      class DayOfWeek < EnumType
        self.options = ['NODAYSPECIFIED', 'SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY']
      end
      ...
      constants.each do |data_type_klass|
        ...
        data_type_klass.load_variables if data_type_klass.methods.include? :load_variables
      end
